...
router.post('/update-quiz-status/:userId', UserController.updateQuizStatus);
router.get('/learning-path/:userId', UserController.getLearningPath);
router.get('/quiz-status/:userId', UserController.getQuizStatus);
